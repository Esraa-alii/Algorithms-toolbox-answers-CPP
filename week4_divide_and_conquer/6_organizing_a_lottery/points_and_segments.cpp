/******************************************************************************
 *
 * File Name: points_and_segments.cpp
 *
 * Description: Answer for problem 6 in week 4 (Algorithm toolbox coursera)
 *
 * Author: Esraa Ali
 *
 *******************************************************************************/
...
vector<int> fast_count_segments(vector<std::pair<int, int>>& ranges,vector<int>& points) {
	vector<int> cnt(points.size());
