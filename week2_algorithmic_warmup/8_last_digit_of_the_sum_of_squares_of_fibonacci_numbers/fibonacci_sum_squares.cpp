/******************************************************************************
 *
 * File Name: fibonacci_sum_squares.cpp
 *
 * Description: Answer for problem 8 in week 2 (Algorithm toolbox coursera)
 *
 * Author: Esraa Ali
 *
 *******************************************************************************/
...
long long fibonacci_sum_squares_optimaize(long long to) {
	if (to <= 1) return to;
...
int main() {
	long long n = 0;
	std::cin >> n;
	std::cout << fibonacci_sum_squares_optimaize(n) << std::endl;
}